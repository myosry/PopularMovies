...
import com.example.dell.popularmovies.activities.DetailFavorite;
...
public class RecyclerFavouriteAdapter  extends RecyclerView.Adapter<RecyclerFavouriteAdapter.FavoriteHolder>  {

    private List<Movie> movieList;
    private Context context;

    public RecyclerFavouriteAdapter( Context context,List<Movie> movieList) {
    ...
    public FavoriteHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        return new RecyclerFavouriteAdapter.FavoriteHolder(view);
    }
    ...
    public void onBindViewHolder(FavoriteHolder holder, int position) {
        ...
        String posterPath = Environment.getExternalStorageDirectory().getPath() + "/" +movieList.get(position).getId();
    ...
    public class FavoriteHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if(position != RecyclerView.NO_POSITION) {
                ...
                if (mToast != null) {
                    mToast.cancel();}
                mToast =Toast.makeText(context,"You choose :"+movieList.get(position).getId() ,Toast.LENGTH_SHORT);
                mToast.show();
                intent.putExtra("title", clickedDataItem.getTitle());
                intent.putExtra("release", clickedDataItem.getReleaseDate());
                intent.putExtra("vote", Double.toString(movieList.get(position).getVoteAverage()));
                intent.putExtra("overview", clickedDataItem.getOverview());
                intent.putExtra("_id", Integer.toString(clickedDataItem.getId()));
